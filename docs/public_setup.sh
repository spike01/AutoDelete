...
mkdir discord
mkdir -p go/src/github.com/spike01/
cd go/src/github.com/spike01; git clone https://github.com/spike01/AutoDelete
cd ~/discord
REPO=$HOME/go/src/github.com/spike01/AutoDelete
...
REPO=/home/autodelete/go/src/github.com/spike01/AutoDelete
SVR_NR=4
